...
It is specially developed for Predictive Maintenance, Photovoltaic Inspection, Environmental Protection, Scientific Research, Aerial Photography, Police Investigation, Disaster Relief & Rescue, Forest Fire Prevention, Urban Safety etc.`,
  ...
  },
  {
    ...
    description:
      `The MIN612R Pro is a tiny size and lightweight infrared thermal imaging core, the compact version of infrared camera core MIN612R. Fully oriented for SWaP-C (size-weight-and-power-cost), the size and weight of MIN612R Pro has already been at the forefront in the industry, making it the best choice for customers who have strict requirements on size and weight when integrating their own drones.
...
It is specially developed for Predictive Maintenance, Photovoltaic Inspection, Environmental Protection, Scientific Research, Aerial Photography, Police Investigation, Disaster Relief & Rescue, Forest Fire Prevention, Urban Safety etc.`,
    category: 'MIN Series',
    features: [
      { title: 'Compact & Lightweight', description: 'Size: 17×17×22mm, Weight: 13g (with 9.1mm lens)' },
      { title: 'Ultra Low Power', description: 'Power consumption as low as 0.7W' },
      { title: 'Clear Image & Accurate Radiometry', description: 'Brand new image algorithm: NUC/3DNR/DNS/DRC/EE' },
      { title: 'SDK Support', description: 'Support Windows/Linux/ARM SDK' },
      { title: 'Various Interfaces', description: 'DVP/LVDS/USB2.0 interfaces, RAW/YUV image data output' },
      { title: 'Temperature Measurement', description: 'Regional, point & isotherm temperature measurement, -20°C~+550°C' },
    ],
    specifications: [
      ...
      { label: 'Spectral Range', values: ['8~14μm'] },
      { label: 'Typical NETD', values: ['≤40mK'] },
      { label: 'Frame Rate', values: ['30Hz'] },
      { label: 'Start-up Time', values: ['5s'] },
      { label: 'Digital Video', values: ['RAW/YUV/BT656'] },
      { label: 'Image Algorithm', values: ['NUC / 3DNR / DNS / DRC / EE'] },
      { label: 'Image Display', values: ['Black Hot / White Hot / Pseudo Color'] },
      { label: 'Standard External Interface', values: ['30Pin HRS: DF40C-30DP-0.4V(51)'] },
      { label: 'USB Expansion Board', values: ['Type-C'] },
      { label: 'Communication Interface', values: ['RS232-TTL / USB2.0'] },
      { label: 'Digital Video Interface', values: ['CMOS8 / USB2.0'] },
      { label: 'Supply Voltage', values: ['4.0~5.0V DC'] },
      { label: 'Typical Power Consumption', values: ['0.7W'] },
      { label: 'Temperature Measurement Range', values: ['-20°C~+150°C, 0°C~550°C (customizable)'] },
      { label: 'Temperature Measurement Accuracy', values: ['±2°C or ±2% (@23°C±3°C)'] },
      { label: 'SDK', values: ['Windows / Linux / ARM'] },
      { label: 'Size', values: ['17×17×22mm (with 9.1mm lens)'] },
      { label: 'Weight', values: ['13g (with 9.1mm lens)'] },
      { label: 'Operating Temperature', values: ['-40°C~+70°C'] },
      { label: 'Storage Temperature', values: ['-45°C~+85°C'] },
      { label: 'Humidity', values: ['5%~95%, Non-condensing'] },
      { label: 'Vibration', values: ['5.35grms, 3 Axis'] },
      { label: 'Shock', values: ['Half-sine Wave, 40g/11ms, 3 Axis 6 Direction'] },
      { label: 'Certificates', values: ['ROHS2.0 / REACH'] },
      { label: 'Optional Lens', values: ['Fixed Focus Athermal: 9.1mm'] },
    ],
  },
