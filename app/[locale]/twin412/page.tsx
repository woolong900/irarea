...
export default async function Twin412Page({ params }: PageProps) {
  const { locale } = await params
  setRequestLocale(locale)
  
  const localizedProduct = getLocalizedProduct('twin412', locale as Locale)
  const relatedProducts = getLocalizedRelatedProducts('twin412', locale as Locale, 4)
