...
export const metadata: Metadata = {
  ...
  keywords: product ? [product.name, product.category, 'thermal imaging', 'infrared', 'IR AREA', 'drone thermal camera', 'UAV thermal module', 'lightweight IR core', 'aerial thermal imaging'] : [],
  openGraph: {
