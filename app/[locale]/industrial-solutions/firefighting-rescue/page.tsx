...
export default async function FirefightingRescuePage({ params }: PageProps) {
  const { locale } = await params
  setRequestLocale(locale)
  const t = await getTranslations('firefightingPage')
  ...
  return (
    <>
      ...
      <RelatedSolutionProducts scenario="firefighting-rescue" locale={locale} />
