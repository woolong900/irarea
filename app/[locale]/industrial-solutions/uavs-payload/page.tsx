...
export default async function UAVsPayloadPage({ params }: PageProps) {
  const { locale } = await params
  setRequestLocale(locale)
  const t = await getTranslations('uavsPage')
  ...
  const applications = [
    ...
    },
    {
      ...
      features: [t('app4_f1'), t('app4_f2'), t('app4_f3'), t('app4_f4'), t('app4_f5'), t('app4_f6')],
  ...
  return (
    <>
      ...
      <RelatedSolutionProducts scenario="uavs-payload" locale={locale} />
