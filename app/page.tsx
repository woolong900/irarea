        ...
        <Container className="relative py-20 md:py-28 lg:py-36">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Leading Infrared Module Solutions
            </h1>
            <p className="text-lg md:text-xl text-neutral-300 mb-8 max-w-2xl">
              High-performance thermal imaging modules for global customers, backed by expert
              application experience.
            </p>
            <p className="text-neutral-400 mb-8">Trusted by industry leaders.</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-neutral-900 mb-6">
                Leading Infrared<br />Detector Manufacturer
              </h3>
              <p className="text-lg md:text-xl text-neutral-600 leading-relaxed mb-6">
                ChengJing Technology specializes in high-performance thermal imaging detectors,
                providing innovative solutions and professional expertise to customers worldwide
                from our state-of-the-art facility in Optics Valley, China.
              </p>
              <p className="text-2xl md:text-3xl font-bold text-primary-600">150+ Global Reach</p>
            </div>
        ...
        <Container>
          ...
          <div className="mb-12">
            ...
            <p className="text-lg md:text-xl text-neutral-600 max-w-2xl">
              Providing high-performance uncooled and cooled thermal imaging detectors for diverse applications worldwide.
            </p>
          </div>
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg md:text-xl text-neutral-600">
              Explore our advanced thermal imaging solutions and professional expertise.
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            {[
              { image: '/images/scenarios/scenario-1.webp', title: 'Thermography', link: '/industrial-solutions/thermography' },
              { image: '/images/safe-city-1.webp', title: 'Security Monitoring', link: '/industrial-solutions/security-monitoring' },
              { image: '/images/gas-detection-1.webp', title: 'Optical Gas Imaging', link: '/industrial-solutions/optical-gas-imaging' },
              { image: '/images/forest-fire-prevention-1.webp', title: 'Firefighting & Rescue', link: '/industrial-solutions/firefighting-rescue' },
              { image: '/images/firefighting-application-1.webp', title: 'UAVs Payload', link: '/industrial-solutions/uavs-payload' },
              { image: '/images/animal-tracking-2.webp', title: 'Personal Vision', link: '/industrial-solutions/personal-vision' },
            ].map((item, index) => {
              const content = (
                <div
                  key={index}
                ...
                >
                  <div className="aspect-square overflow-hidden relative">
                    <Image
                      src={item.image}
                      alt={item.title || `Application scenario ${index + 1}`}
                      fill
